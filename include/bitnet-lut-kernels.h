...
#pragma unroll
        for (int i = 0; i < BM6912_2560; i++) {
            ((int32_t*)C)[i] = (int32_t)(((int32_t*)CBits)[i + bs * BM6912_2560]);
        }
  }
  return 0;
}
...
#pragma unroll
        for (int i = 0; i < BM2560_6912; i++) {
            ((int32_t*)C)[i] = (int32_t)(((int32_t*)CBits)[i + bs * BM2560_6912]);
        }
  }
  return 0;
}
...
#pragma unroll
        for (int i = 0; i < BM2560_2560; i++) {
            ((int32_t*)C)[i] = (int32_t)(((int32_t*)CBits)[i + bs * BM2560_2560]);
        }
  }
  return 0;
}
