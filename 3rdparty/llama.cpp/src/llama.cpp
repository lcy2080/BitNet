...
enum llm_kv {
    ...
    LLM_KV_ROPE_SCALING_LONGROPE2_FACTORS,
    LLM_KV_ROPE_SCALING_LONGROPE2_MSCALE,
...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_ROPE_SCALING_LONGROPE2_FACTORS, "%s.rope.scaling.longrope2_factors"      },
    { LLM_KV_ROPE_SCALING_LONGROPE2_MSCALE,  "%s.rope.scaling.longrope2_mscale_policy"},
...
static const std::map<llama_rope_scaling_type, const char *> LLAMA_ROPE_SCALING_TYPES = {
    ...
    { LLAMA_ROPE_SCALING_TYPE_LONGROPE2, "longrope2" },
};
...
struct llama_hparams {
    ...
    // for LongRoPE2
    std::vector<float> rope_longrope2_factors;
    std::string        rope_longrope2_mscale;
